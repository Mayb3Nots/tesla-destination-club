...
<svelte:head>
	<title>{isResetMode ? 'Reset Password' : isSignUp ? 'Sign Up' : 'Sign In'} — Tesla Destination Club</title>
</svelte:head>
...
<div class="flex min-h-screen items-center justify-center bg-surface px-4">
	...
	<div class="animate-scale-in relative z-10 w-full max-w-md">
		...
		<div class="rounded-2xl border border-border bg-surface-elevated p-6 sm:p-8">
					...
					<div>
						<div class="mb-1.5 flex items-center justify-between">
							...
							<button
								...
								class="text-xs font-medium text-tesla-red hover:text-tesla-red-light transition-colors"
							>
								Forgot password?
							</button>
						</div>
				...
				{#if resetSent}
					<div class="rounded-lg bg-accent-green/10 px-4 py-3 text-sm text-accent-green">
